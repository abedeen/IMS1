...
public class CategoryResourceIntTest {
    ...
    private static final String DEFAULT_CATEGORY_LEVEL = "AAAAAAAAAA";
    private static final String UPDATED_CATEGORY_LEVEL = "BBBBBBBBBB";
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCategoryLevel()).isEqualTo(DEFAULT_CATEGORY_LEVEL);
    }
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].categoryLevel").value(hasItem(DEFAULT_CATEGORY_LEVEL.toString())));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.categoryLevel").value(DEFAULT_CATEGORY_LEVEL.toString()));
    }
    ...
    public void updateCategory() throws Exception {
        ...
        updatedCategory
            ...
            .categoryLevel(UPDATED_CATEGORY_LEVEL);
        ...
        assertThat(testCategory.getCategoryLevel()).isEqualTo(UPDATED_CATEGORY_LEVEL);
    }
